      ...
      <div className="min-h-screen">
        ...
        <div className="h-screen flex justify-center items-center">
          <div className="flex flex-col items-center justify-center">
            ...
            <button
              className="text-white rounded-lg mt-4 w-12 h-12 flex items-center justify-center"
              onClick={onOpen}
            >
              {isDarkMode ? (
                <box-icon name="question-mark" color="#ffff"></box-icon>
              ) : (
              ...
              <ModalContent>
                {(onClose) => (
                  <>
                    ...
                    <ModalBody>
                      <p>
                        A sua senha de 4 digitos é os ultimos 4 digitos do seu
                        cartão principal. Ou seja o cartão que você recebeu ao
                        cadastrar sua conta.
                      </p>
                      <p>
                        Não recomendamos que você continue com essa senha, pois
                        ela é facilmente descoberta. Recomendamos que você
            ...
            <div className="botoes-acoes flex flex-row gap-4">
              <button
                className="text-white p-2 rounded-lg mt-4 w-1/2 h-12 flex items-center justify-center"
                onClick={() => {
                  fetchCartao();
                }}
              >
                {isDarkMode ? (
                  <box-icon name="paper-plane" color="#ffff"></box-icon>
                ) : (
                  <box-icon name="paper-plane"></box-icon>
                )}
              </button>
              <button
                className="text-white p-2 rounded-lg mt-4 w-1/2 h-12 dark:invert flex items-center justify-center"
              ...
              >
                {isDarkMode ? (
                  <box-icon name="arrow-back" color="#ffff"></box-icon>
                ) : (
      ...
      {!digitouSenha ? (
        ...
        <div>
          ...
          <div className="botoes-acoes flex justify-center flex-col xl:flex-row">
            <button
              className="bg-green-700 text-white p-2 rounded-lg mt-4 w-full h-12 xl:w-[10%]"
              onClick={() => navigate("/home")}
            >
              Voltar
            </button>
